        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 flex flex-col lg:flex-row items-center gap-12">
          <div className="max-w-2xl relative flex-1">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-[56px] font-black text-ishes-blue leading-[1.05] tracking-tight mb-4">
              ...
              <span className="text-ishes-gold ">Tu rejoins une communauté qui t'accompagne dans ton cheminement.</span>
            </h1>
      ...
      <section className="pt-8 pb-24 bg-[#fafafa]">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="bg-[#f9f5f0] rounded-[2.5rem] overflow-hidden shadow-lg flex flex-col relative group">
              <div className="h-56 relative overflow-hidden">
                <Image src="/images/formations/aqida-2.png" alt="Coran" fill className="object-cover group-hover:scale-105 transition-transform duration-700" />
              </div>
              <div className="p-8 pt-12 relative flex-1">
                <div className="absolute -top-10 left-8 w-20 h-20 bg-ishes-dark rounded-full flex items-center justify-center border-4 border-[#f9f5f0] shadow-md text-ishes-gold">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-white leading-tight">
              ...
              <span className="text-ishes-gold ">Nous voulons former des hommes et des femmes qui cheminent.</span>
            </h2>
          </div>
      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-white leading-tight mb-6">
            ...
            <span className="text-ishes-gold ">Tu rejoins une famille qui prie pour ta réussite, répond à tes questions et t'accompagne jusqu'au bout.</span>
          </h2>
