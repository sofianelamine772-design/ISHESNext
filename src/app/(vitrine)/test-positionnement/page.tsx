        ...
        <div className="max-w-3xl mx-auto relative z-10">
          {!testType ? (
            ...
            >
              ...
              <h1 className="text-4xl md:text-6xl font-black text-ishes-blue mb-6 uppercase leading-tight">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                >
                  ...
                  <h3 className="text-xl font-black text-ishes-blue mb-2 uppercase">Langue Arabe</h3>
                ...
                >
                  ...
                  <h3 className="text-xl font-black text-ishes-blue mb-2 uppercase">Tajwid</h3>
            ...
            >
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <h2 className="text-2xl md:text-3xl font-black text-ishes-blue mb-4 leading-tight">
            ...
            >
              ...
              <h2 className="text-3xl font-black text-ishes-blue mb-4 uppercase">Test Terminé !</h2>
