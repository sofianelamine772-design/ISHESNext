...
export const metadata: Metadata = {
  title: "Connexion | Espace Membre ISHES",
  description: "Accédez à votre espace étudiant, suivez vos cours et gérez votre scolarité à l'Institut ISHES.",
};

export default function SignInPage() {
  return (
    <div className="min-h-screen relative flex items-center justify-center bg-[#FAFAFA] p-6 overflow-hidden">
