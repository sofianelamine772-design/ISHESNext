...
export default function EleveLayout({
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      {/* Main Content */}
      <main className="flex-1 flex flex-col pl-72">
        {/* Top Header */}
        <header className="h-24 bg-white/80 backdrop-blur-md border-b border-gray-200 flex items-center justify-between px-10 sticky top-0 z-40">
          <div>
