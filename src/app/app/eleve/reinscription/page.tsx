    ...
    return (
      <div className="h-[60vh] flex flex-col items-center justify-center space-y-8 text-center">
        ...
        <button 
          ...
          className="bg-ishes-blue text-white px-10 py-5 rounded-2xl font-black uppercase tracking-widest text-xs shadow-xl shadow-ishes-blue/20"
        >
  ...
  if (loading) {
    return (
      <div className="h-[60vh] flex flex-col items-center justify-center space-y-4">
        <Loader2 className="w-12 h-12 text-ishes-blue animate-spin" />
      ...
      {!activeCourse ? (
        ...
        <>
          ...
          <div className="relative rounded-[3.5rem] p-12 md:p-16 shadow-2xl overflow-hidden group">
            ...
            <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-ishes-blue rounded-full blur-[120px] opacity-20 -translate-x-1/2 -translate-y-1/2 group-hover:opacity-30 transition-opacity duration-700 pointer-events-none z-0"></div>
            ...
            <div className="relative z-10 grid lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-10">
                <div className="space-y-4">
                  <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-ishes-blue/20 border border-ishes-blue/30 text-ishes-blue backdrop-blur-sm">
                ...
                <div className="flex flex-col sm:flex-row gap-2 p-1.5 bg-white/5 rounded-[1.5rem] border border-white/10 w-full sm:w-max">
                  <button 
                    ...
                    className={`px-5 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all flex items-center justify-center gap-2 ${courseChoice === 'same' ? 'bg-ishes-blue text-white shadow-lg shadow-ishes-blue/20' : 'text-gray-400 hover:text-white hover:bg-white/5'}`}
                  >
                ...
                <div className="space-y-5">
                  <div className="flex items-center gap-4 text-gray-300 transform transition-transform hover:translate-x-2 duration-300">
                    <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-[#086b51] to-[#044a37] flex items-center justify-center shadow-lg shadow-ishes-blue/30 shrink-0">
                ...
                <div className="bg-[#ffffff]/5 backdrop-blur-2xl border border-white/10 rounded-[3rem] p-10 md:p-12 space-y-8 relative z-10 shadow-[0_8px_32px_0_rgba(0,0,0,0.3)] hover:border-white/20 transition-colors duration-500">
                  ...
                  <div className="space-y-4">
                    <button 
                      ...
                      disabled={paying}
                      className="w-full relative overflow-hidden bg-gradient-to-r from-[#086b51] to-[#0a8f6b] text-white py-6 rounded-[1.5rem] font-black uppercase tracking-[0.2em] text-[11px] flex items-center justify-center gap-3 transition-all hover:scale-[1.03] active:scale-[0.98] shadow-2xl shadow-ishes-blue/40 disabled:opacity-50 disabled:cursor-not-allowed group/btn"
                    >
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="p-8 bg-gray-50/50 rounded-3xl border border-gray-100 flex gap-6 items-start">
              <div className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center shrink-0 shadow-sm">
                  <Sparkles className="w-6 h-6 text-ishes-blue" />
              </div>
              <div>
            ...
            <div className="p-8 bg-gray-50/50 rounded-3xl border border-gray-100 flex gap-6 items-start">
              <div className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center shrink-0 shadow-sm">
                  <UserPlus className="w-6 h-6 text-ishes-blue" />
              </div>
              <div>
