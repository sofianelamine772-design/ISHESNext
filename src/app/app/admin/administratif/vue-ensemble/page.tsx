        ...
        <header className="h-20 bg-white border-b border-gray-100 flex items-center justify-between px-6 md:px-8 shrink-0 z-10 sticky top-0">
          <div className="flex items-center gap-4">
            ...
            <div className="min-w-0">
              <Link
                href="/app/admin/administratif"
                className="inline-flex items-center gap-1.5 text-[10px] font-black uppercase tracking-widest text-gray-400 hover:text-ishes-blue transition-colors mb-1"
              >
                <ArrowLeft className="w-3 h-3" /> Administratif
              </Link>
