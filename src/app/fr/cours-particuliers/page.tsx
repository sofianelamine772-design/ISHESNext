          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
            <div className="flex-1 space-y-8 text-center lg:text-left">
              <nav className="flex items-center justify-center lg:justify-start gap-2 text-xs font-bold text-gray-400 uppercase tracking-[0.2em] mb-4">
                ...
                <span className="text-ishes-blue">Cours Particuliers</span>
              </nav>
              
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-ishes-blue/10 rounded-full shadow-sm mb-2">
                <Users className="w-4 h-4 text-ishes-blue" />
              ...
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-6 pt-4">
                ...
                <div className="flex items-center gap-2">
                  <Star className="w-5 h-5 text-ishes-blue" />
            ...
            <div className="flex-1 w-full max-w-[500px] aspect-square relative">
               <div className="absolute inset-0 bg-ishes-blue/5 rounded-[3rem] rotate-3 -z-10" />
        ...
        <div className="max-w-7xl mx-auto px-6">
           <div className="bg-white rounded-[4rem] p-12 md:p-20 shadow-xl border border-gray-100 grid lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-8">
                 ...
                 <div className="space-y-4">
                    <div className="flex items-center gap-4">
                       <CheckCircle2 className="w-6 h-6 text-ishes-blue shrink-0" />
              ...
              <div className="bg-[#101828] rounded-[3rem] p-12 text-white relative overflow-hidden group">
                 <div className="absolute inset-0 bg-ishes-blue/5 blur-3xl rounded-full scale-150 group-hover:bg-ishes-blue/10 transition-colors" />
