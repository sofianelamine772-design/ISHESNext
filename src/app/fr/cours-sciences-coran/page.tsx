...
export const metadata = {
  title: 'Cours sciences coran | ISHES',
  description: 'Page en construction pour Cours sciences coran. Retrouvez bientôt tout le contenu.',
};
      ...
      <main className="flex-1 flex flex-col items-center justify-center relative z-10 px-4 py-24 text-center">
        <div className="w-full max-w-3xl mx-auto bg-white p-12 md:p-16 rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100 space-y-6">
          ...
          <p className="text-lg text-gray-500 font-medium">
            Cette page (<strong>/fr/cours-sciences-coran</strong>) a été conservée pour préserver votre référencement SEO. Elle est actuellement en cours de développement.
          </p>
