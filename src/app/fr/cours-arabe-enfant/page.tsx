...
export default function CoursArabeEnfantPage() {
  const course = PROGRAMS_DATA["arabe_enfant_distance"];
    ...
    <div className="min-h-screen bg-[#fafafa] font-sans selection:bg-ishes-gold selection:text-white pb-20">
      ...
      <section className="pt-28 pb-6 px-6 max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="flex-1 space-y-6">
            ...
            <h2 className="text-xl md:text-2xl text-[#b88c4d] font-bold leading-snug">
              Donner à votre enfant une langue,<br/>
              c'est lui transmettre une identité.
            </h2>
            <p className="text-gray-600 font-medium max-w-md text-lg leading-relaxed">
              Une formation complète et interactive pour apprendre l'arabe écrit et parlé, développer sa confiance et réussir dans un environnement bienveillant.
            </p>
            
            <div className="pt-2 flex flex-wrap items-center gap-4">
              <Link 
                href="/inscription?plan=arabe_enfant_distance&audience=enfant" 
        ...
        <div className="flex flex-wrap items-center justify-between gap-x-6 gap-y-6 pt-12 mt-12 border-t border-gray-200 w-full">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-[11px] font-bold text-ishes-dark leading-tight uppercase tracking-wider">1 cours / semaine<br/><span className="text-gray-500 font-medium capitalize tracking-normal">Mardi ou jeudi<br/>selon le niveau à 18h30</span></span>
          </div>
          <div className="hidden md:block w-px h-8 bg-gray-200"></div>
      ...
      <section className="pt-12 pb-20 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { icon: BookOpen, title: "Tu es parent et tu veux\noffrir à ton enfant un\napprentissage solide de\nla langue arabe." },
            { icon: MessageCircle, title: "Tu souhaites qu'il\napprenne à lire, écrire\net parler arabe avec\nconfiance." },
            { icon: Heart, title: "Tu veux l'aider à\ncomprendre le Coran\net à développer son lien\navec sa religion." },
            { icon: BarChart3, title: "Tu recherches une méthode\nadaptée aux enfants\nfrancophones, progressive\net motivante." }
          ].map((item, i) => (
      ...
      <section className="py-16 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-[1fr_1.2fr] gap-12 items-center">
          ...
          <div className="space-y-8">
            {[
              { 
                title: "Une méthode progressive et adaptée aux enfants", 
                desc: "Des supports clairs et ludiques pour transmettre l'arabe étape par étape." 
              },
              { 
                title: "Des cours interactifs et motivants", 
                desc: "Apprentissages par le jeu, activités variées, mises en situation et participation active." 
              },
              { 
                title: "Des enseignants expérimentés et bienveillants", 
                desc: "Spécialisés dans l'enseignement de l'arabe aux enfants, pour les accompagner avec patience et exigence." 
              },
              { 
                title: "Replay et suivi personnalisé", 
                desc: "Replay disponible après chaque cours et suivi via le groupe WhatsApp pour encourager et guider votre enfant." 
              },
              { 
                title: "Une ouverture vers le Coran et l'Islam", 
                desc: "Comprendre la langue du Coran, les invocations et les valeurs islamiques dès le plus jeune âge." 
              }
            ].map((item, i) => (
      ...
      <section className="py-12 px-6 max-w-7xl mx-auto mb-8">
        <div className="bg-[#f5f6f8] rounded-[2rem] p-8 md:p-12 shadow-sm grid md:grid-cols-2 gap-8 md:gap-16 border border-gray-100">
          <div className="flex flex-col sm:flex-row gap-6 items-start">
            ...
            <div>
              <h3 className="font-black text-ishes-blue text-lg mb-4 leading-tight uppercase tracking-wide">UNE PÉDAGOGIE DE QUALITÉ</h3>
              <ul className="text-sm font-medium text-ishes-dark leading-relaxed space-y-2">
                <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-ishes-gold shrink-0"></span> Manuel pédagogique complet</li>
