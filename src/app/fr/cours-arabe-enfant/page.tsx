          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-12">
            <div className="flex-1 space-y-8 text-center md:text-left">
              ...
              <h1 className="text-4xl sm:text-5xl md:text-7xl font-black text-ishes-dark leading-[1.1] tracking-tight">
                Cours <span className="text-[#c8a96e]">d'arabe</span> <br />
                <span className="text-[#c8a96e] italic">pour les enfants</span>.
              </h1>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 pt-4">
                ...
                <div className="flex flex-col items-center sm:items-start">
                   ...
                   <p className="text-[#c8a96e] text-lg font-black italic">
            ...
            <div className="flex-1 w-full max-w-[500px] aspect-square relative">
               ...
               <div className="w-full h-full bg-white rounded-[3rem] shadow-2xl border border-gray-100 p-8 flex flex-col justify-center items-center gap-8 relative overflow-hidden group">
                  ...
                  <Baby className="w-32 h-32 text-[#c8a96e]/20 group-hover:scale-110 transition-transform duration-500" />
         ...
         <div className="max-w-7xl mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-12 items-center">
               ...
               <div className="bg-white p-10 rounded-[3rem] border border-gray-100 shadow-sm space-y-6">
                  ...
                  <Link href="/contact" className="inline-flex items-center gap-2 text-[#c8a96e] font-black text-sm uppercase tracking-widest hover:gap-3 transition-all">
