      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden bg-[#fafafa]">
        ...
        <div className="max-w-7xl mx-auto relative z-10 pt-10 text-center">
           ...
           <h1 className="text-4xl sm:text-6xl md:text-8xl font-black text-ishes-dark leading-[1.1] tracking-tight mb-8">
             Ne cheminez plus <br />
             <span className="text-ishes-blue italic">seul</span> vers ALLAH.
           </h1>
           ...
           <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <div className="bg-white/50 backdrop-blur-sm p-4 px-8 rounded-2xl border border-gray-100 flex flex-col items-center">
                 <p className="text-ishes-blue text-3xl font-black italic tracking-tight uppercase">Offert</p>
           ...
           <div className="grid md:grid-cols-3 gap-8">
              {benefits.map((b, i) => (
                <div key={i} className="bg-gray-50 p-10 rounded-[3rem] border border-gray-100 hover:bg-white hover:shadow-2xl transition-all group">
                   <div className="w-12 h-12 rounded-2xl bg-ishes-blue/10 text-ishes-blue flex items-center justify-center mb-8 group-hover:bg-ishes-blue group-hover:text-white transition-all">
                      {b.icon}
                   </div>
      ...
      <section className="py-24 bg-[#fafafa]">
        <div className="max-w-7xl mx-auto px-6">
           <div className="bg-[#101828] rounded-[4rem] p-12 md:p-24 text-white relative overflow-hidden">
              <div className="absolute top-0 right-0 w-96 h-96 bg-ishes-blue/10 rounded-full blur-[120px] -mr-48 -mt-48" />
              <div className="relative z-10 grid lg:grid-cols-2 gap-20 items-center">
                 <div className="space-y-10">
                    <h2 className="text-4xl md:text-5xl font-black leading-tight tracking-tight">Une expérience qui dépasse le simple <span className="text-ishes-blue">apprentissage</span></h2>
                 ...
                 <div className="bg-white rounded-[3rem] p-10 space-y-8 shadow-2xl relative overflow-hidden">
                    <div className="absolute top-0 right-0 p-6 opacity-10">
                      <Gift className="w-32 h-32 text-ishes-blue" />
                    </div>
                    <div className="flex items-center gap-3 relative z-10">
                       <ShieldCheck className="w-8 h-8 text-ishes-blue" />
                    ...
                    <p className="text-ishes-blue font-bold text-sm italic relative z-10">
                      Parce que nous croyons que le plus beau des enseignements est celui qui se poursuit bien après la fin du cours.
                    </p>
                    <div className="relative z-10 pt-4">
                      <Link href="/inscription?plan=pack_accompagnement" className="block w-full bg-ishes-blue text-white py-5 rounded-2xl font-black text-center shadow-xl shadow-ishes-blue/20">
