      ...
      <div className="max-w-7xl mx-auto px-6 py-20 text-center">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-y-12 gap-x-6">
          ...
          <div className="flex flex-col items-center lg:border-r border-gray-100 last:border-0">
            ...
            <span className="font-bold text-[#0a192f] text-sm md:text-base leading-snug text-center">Tous les dimanches<br />de 9h00 à 12h00</span>
          </div>
          <div className="flex flex-col items-center lg:border-r border-gray-100 last:border-0">
          ...
          <div className="flex flex-col items-center lg:border-r border-gray-100 last:border-0">
            <FileText className="w-10 h-10 text-[#0a192f] mb-4" strokeWidth={1.5} />
          ...
          <div className="flex items-center gap-6 lg:gap-10">
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col">
                <span className="text-gray-400 font-bold text-sm">Tarif</span>
