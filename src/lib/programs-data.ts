export const PROGRAMS_DATA: Record<string, any> = {
  ...
  "al_aqida": {
    ...
    description: "❓ C'EST QUOI ?\nCe cours explore les piliers de la foi musulmane en s'appuyant sur l'ouvrage incontournable de l'Imam Tahawi (La Tahawiya).\n\n👤 POUR QUI ?\nTout musulman souhaitant consolider ses bases et comprendre la croyance sunnite authentique.\n\n⏳ QUAND ?\nSession de 4 mois.\n\n💻 COMMENT ?\nCours en direct avec sessions de questions-réponses et étude structurée du livre.\n\n🎯 OBJECTIFS\nVous découvrirez l'impact des paroles et des actes sur la foi et ancrerez vos convictions sur des bases académiques et spirituelles solides.",
    features: [
