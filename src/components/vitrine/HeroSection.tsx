    ...
    <main className="relative z-10 flex flex-col items-center text-center px-4 pt-28 sm:pt-32 md:pt-44 pb-20 min-h-screen">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
          <Link href="/program" className="group flex items-center gap-3 bg-ishes-green hover:bg-ishes-green-hover text-white px-8 py-4 rounded-full text-[15px] font-bold transition-all hover:-translate-y-0.5 shadow-xl shadow-ishes-green/20">
            Voir nos cours
