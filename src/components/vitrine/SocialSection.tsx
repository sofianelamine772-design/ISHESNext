    ...
    <section className="bg-white border-t border-gray-100 py-20 md:py-24">
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        >
          ...
          <div className="grid grid-cols-2 md:flex md:flex-row items-center justify-center gap-6 md:gap-10">
            {/* Facebook */}
            <a
            ...
            >
              <div className="w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 rounded-3xl bg-[#f0f4ff] group-hover:bg-[#1877F2] flex items-center justify-center transition-all duration-300 shadow-sm group-hover:shadow-xl group-hover:shadow-[#1877F2]/25 group-hover:-translate-y-2">
            ...
            <a
              ...
              className="group flex flex-col items-center gap-4"
            >
              <div className="w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 rounded-3xl bg-gray-50 group-hover:bg-black flex items-center justify-center transition-all duration-300 shadow-sm group-hover:shadow-xl group-hover:shadow-black/20 group-hover:-translate-y-2">
            ...
            <a
              ...
              className="group flex flex-col items-center gap-4"
            >
              <div className="w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 rounded-3xl bg-[#fff5f5] group-hover:bg-[#FF0000] flex items-center justify-center transition-all duration-300 shadow-sm group-hover:shadow-xl group-hover:shadow-[#FF0000]/25 group-hover:-translate-y-2">
