        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 z-10">
          <div className="max-w-2xl relative pt-10">
            ...
            <h1 className="ishes-heading text-[40px] sm:text-5xl md:text-[64px] font-black text-ishes-dark leading-[1.1] tracking-tight mb-6">
              Lis le Coran <br />
              avec assurance, <br />
              <span className="text-ishes-gold italic font-serif">même si tu pars de zéro.</span>
            </h1>
          ...
          <section>
            ...
            <div className="mt-12 text-center relative flex items-center justify-center">
              ...
              <div className="relative bg-[#fafafa] px-6">
                <span className="font-serif italic text-xl text-[#c8a063] font-bold">Cette formation a été créée pour toi.</span>
              </div>
            </div>
          </section>
      ...
      <section className="relative w-full bg-[#101828] py-24 lg:py-32 overflow-hidden mt-10">
        ...
        <div className="relative max-w-5xl mx-auto px-6 text-center z-10">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-medium text-white mb-10 leading-tight">
            ...
            <span className="font-serif italic text-[#c8a063] font-bold">lis-le avec confiance, précision et sérénité.</span>
          </h2>
          <Link
            href="/inscription?plan=tajwid_standard&audience=adulte"
