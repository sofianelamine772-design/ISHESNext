      ...
      >
        ...
        <div className="group relative overflow-hidden bg-[#f9f5f0] rounded-[2.5rem] border border-ishes-gold/10 hover:border-ishes-gold/30 p-10 hover:shadow-2xl hover:-translate-y-1 transition-all duration-500">
          ...
          <a 
            ...
            className="group/wa flex items-center gap-5 bg-[#25D366] hover:bg-[#1fad55] rounded-2xl p-6 mb-8 transition-all duration-300 hover:shadow-xl hover:shadow-[#25D366]/20 hover:-translate-y-0.5"
          >
            ...
            <div>
              ...
              <p className="font-bold text-white/70 text-sm">Contacter uniquement sur WhatsApp</p>
            </div>
        ...
        <div className="group relative overflow-hidden bg-[#f9f5f0] rounded-[2.5rem] border border-ishes-gold/10 hover:border-ishes-gold/30 p-10 hover:shadow-2xl hover:-translate-y-1 transition-all duration-500">
          ...
          <a href="tel:+33686911301" className="flex items-center gap-4 mb-8 group/phone">
            <div className="w-16 h-16 rounded-2xl bg-ishes-dark flex items-center justify-center shrink-0 shadow-lg shadow-ishes-dark/20 group-hover/phone:scale-110 transition-transform">
              <svg viewBox="0 0 24 24" className="w-7 h-7 fill-white">
                <path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z" />
              </svg>
            ...
            <div>
              <span className="ishes-label text-[10px] opacity-40 block mb-0.5">Appelez nous ou laissez nous un message sur WhatsApp</span>
              <span className="ishes-heading text-2xl text-ishes-dark group-hover/phone:text-ishes-blue transition-colors">+33 6 86 91 13 01</span>
            </div>
          </a>

          <a 
            href="https://wa.me/33686911301" 
            target="_blank" 
            rel="noopener noreferrer"
